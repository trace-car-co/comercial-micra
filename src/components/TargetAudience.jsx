...
export default function TargetAudience() {
  return (
    <section id="nosotros" aria-label="Industrias que usan calibración y metrología" className="bg-off py-24 lg:py-32 px-5 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          >
            Calibración de equipos para sectores que{' '}
          ...
          {audiences.map((a, i) => (
            ...
            >
              <SpotlightCard
                ...
                className="bg-white rounded-2xl p-6 flex flex-col items-center text-center border border-gray-100 hover:border-primary/20 hover:shadow-lg hover:shadow-primary/5 transition-all cursor-default group h-full"
              >
